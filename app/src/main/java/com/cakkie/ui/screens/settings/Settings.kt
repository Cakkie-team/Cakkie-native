        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = { expanded = !expanded }) {
                    ...
                    Image(
                        painter = if (expanded) painterResource(id = R.drawable.arrow_down) else painterResource(
                ...
                Column(
                    ...
                    Row(
                       ...
                       Text (text = switch.text)
                            ...
                            Switch(checked = switch.isChecked, onCheckedChange = {
                                isChecked -> switch = switch.copy(isChecked = isChecked)
                            })
                                Text(
