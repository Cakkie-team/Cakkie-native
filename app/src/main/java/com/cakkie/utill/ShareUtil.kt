...
object ShareUtil {
    ...
    fun share(context: Context, contentType: ContentType, contentId: String, username: String? = null, shareMessage: String? = null) {
        ...
        if (shareIntent.resolveActivity(context.packageManager) != null) {
            ...
            Toast.makeText(context , "No app available to handle share action" , Toast.LENGTH_SHORT).show()
        }
    }
